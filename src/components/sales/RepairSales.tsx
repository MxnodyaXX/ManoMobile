    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      {showCreditConfirm && (
        <CreditRecordConfirmModal
          dealer={selectedDealer}
          dueAmount={finalDue}
          onConfirm={() => { setCreditRecordMade(true); setShowCreditConfirm(false); setView("invoice"); }}
          onSkip={() => { setCreditRecordMade(false); setShowCreditConfirm(false); setView("invoice"); }}
